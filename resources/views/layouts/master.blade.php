...
<html lang="en">
    ...
    <head>
        ...
        <title>Jarabu Tours & Travel</title>
    ...
    <body>
        ...
        <div id="top" class="header">
            ...
            <!-- <div class="container1"> -->
                ...
                <a href="#services" class="btn header-btn">Find Out More</a>
                <br/>
...
Book your Fist Class, Business Class & Economy Class at your Own Convenience....</p>
                    ...
                    <div class="col-md-3 text-center">
                        <div class="service-item">
                            <i class="service-icon fa fa-heartbeat"></i>
                            <h4 class="service-title">MEDICAL TOURISM</h4>
                            <p class="service-desc">#Medical_Tourism your health is our concern. Get affordable, better access to care or a higher level quality care.</p>
                        </div>
                    </div>
                    <div class="col-md-3 text-center">
                        <div class="service-item">
                    ...
                    <div class="col-md-3 text-center">
                        <div class="service-item">
                            <i class="service-icon fa fa-vcard"></i>
                            <h4 class="service-title">VISA PROCESSING</h4>
                            <p class="service-desc"> Visa and Passport Application Processing Services.</p>
                        ...
                        <div class="grid center-block">
                            <figure class="effect-zoe">
                                ...
                                <figcaption>
                                    ...
                                    <p class="description">
                                    The most famous attractions include the Sydney Opera House, and the Sydney Harbour Bridge.
                                    </p>
                                </figcaption>           
                            </figure>
                        </div>
        ...
        <div id="contact" class="container parallax">
            ...
            <!-- Contact Inner -->
            <div class="inner contact" id = "inner_contact">
                <!-- Form Area -->
...
s.parentNode.insertBefore(ga, s);
                    ...
                    <form id="contact-us" name = "sendMails">
                        ...
                        <div class="col-xs-6 col-xs-12 animated" data-animation="fadeInLeft" data-animation-delay="300">
                            ...
                            <select class="custom-select" id="inputGroupSelect01" name="subject">
                                ...
                                <option name = "subject" value="jarabu">About Jarabu Tours</option>
                                <option name = "subject" value="medical">About medical Tourism</option>
                                <option name = "subject" value="sales">For sales</option>
                                <option name = "subject" value="question">A Question</option>
            ...
            <div id = "messages" class="mail-message-area">
                    <!-- Message -->
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3 text-center">
                        <ul class="list-inline">
                            <li>
                                <i class="fa fa-facebook"><a href = ""></a>https://www.facebook.com/Jtours/</i>
                            </li>
                            <li>
                        ...
                        <hr>
                        <p>Copyright &copy; <a href="#">Jarabu Designs</a>  2017</p>
    ...
    function messageSent(){
        document.getElementById("inner_contact").style.display = "none";
